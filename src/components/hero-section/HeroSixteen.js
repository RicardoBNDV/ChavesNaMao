            ...
            <div className="ins-hero-content text-center">
              <div className="ins-title text-center">
                <h1 className="display-3 ins-heading mb-20 fw-semibold">
                  Parceria Exclusiva <mark>BNDV</mark> e <mark2>Chaves na Mão</mark2>.
                </h1>
                <p className="mb-5">
                O BNDV é agora parceiro exclusivo deste portal de crescimento explosivo, entregando mais de 1000 leads diários.
                </p>
